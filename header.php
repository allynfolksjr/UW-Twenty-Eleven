...
<!--<![endif]-->
<head>
<link rel="stylesheet" href="http<?if($_SERVER['HTTPS'] == "on") echo "s";?>://depts.washington.edu/uweb/inc/css/header.css" type="text/css" />
<link rel="stylesheet" href="http<?if($_SERVER['HTTPS'] == "on") echo "s";?>://depts.washington.edu/uweb/inc/css/footer.css" type="text/css" />
